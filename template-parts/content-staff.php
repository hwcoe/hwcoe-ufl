	...
	<div class="entry-content">
		...
		<?php if( have_rows('staff_listing') ): ?>
			...
			<?php if ($staff_photo_url != ''): ?>
				<div class="col-md-3">			
					<img src="<?php echo esc_url($staff_photo_url); ?>" alt="<?php echo esc_attr($staff_name); ?>" width="180" />
				</div>
				<div class="col-md-9">
			<?php else: ?>
				<div class="col-md-12">
			<?php endif; // $staff_photo_url ?>
					...
					<?php echo wpautop( wp_kses_post($staff_description) ); ?>
					<?php endif; // $staff_description ?>
				</div>
			</div> <!-- row -->

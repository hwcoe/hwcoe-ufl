...
function hwcoe_ufl_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'post_sidebar',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s" aria-label="%1$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget %2$s ' . hwcoe_ufl_sidebar_widget_classes('site_footer') . '" aria-label="%1$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget %2$s" aria-label="%1$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title" id="title">',
		'after_title'   => '</h2>',
	) );

...
class UFL_2015_Landing_Page_Double extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => __('Creates a layout with two images next to each other with content.', 'hwcoe-ufl'),
			'customize_selective_refresh' => true,
		);
		$control_ops = array();
		parent::__construct( 'ufl-landing-page-double-image', __('UFL Landing Page Double Image', 'hwcoe-ufl'), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image1' ); ?>"><?php _e( 'Primary Image', 'hwcoe-ufl' ); ?>:</label>
        <div class="wpshed-media-container">
            <div class="wpshed-media-inner">
                ...
                <span class="wpshed-no-image" id="<?php echo $this->get_field_id( 'image1' ); ?>-noimg" <?php echo $no_img_style; ?>><?php _e( 'No image selected', 'hwcoe-ufl' ); ?></span>
            </div>
		...
		<input type="button" value="<?php echo _e( 'Remove', 'hwcoe-ufl' ); ?>" class="button wpshed-media-remove" id="<?php echo $this->get_field_id( 'image1' ); ?>-remove" <?php echo $img_style; ?> />
		<?php $image_button_text = ( $instance[ 'image1' ] != '' ) ? __( 'Change Image', 'hwcoe-ufl' ) : __( 'Select Image', 'hwcoe-ufl' ); ?>
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'image2' ); ?>"><?php _e( 'Secondary Image', 'hwcoe-ufl' ); ?>:</label>
        <div class="wpshed-media-container">
            <div class="wpshed-media-inner">
                ...
                <span class="wpshed-no-image" id="<?php echo $this->get_field_id( 'image2' ); ?>-noimg" <?php echo $no_img_style; ?>><?php _e( 'No image selected', 'hwcoe-ufl' ); ?></span>
            </div>
		...
		<input type="button" value="<?php echo _e( 'Remove', 'hwcoe-ufl' ); ?>" class="button wpshed-media-remove" id="<?php echo $this->get_field_id( 'image2' ); ?>-remove" <?php echo $img_style; ?> />
		<?php $image_button_text = ( $instance[ 'image2' ] != '' ) ? __( 'Change Image', 'hwcoe-ufl' ) : __( 'Select Image', 'hwcoe-ufl' ); ?>
